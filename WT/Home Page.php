...
$btn="<a href='create_account.php' style='position: absolute; right:30px; top:10px; text-decoration:none;'>Create Account</a>";
$signin='<a href="login.php" style="position: absolute; right:175px; top:10px; text-decoration:none;">Sign In</a>';
...
<div id="createaccount" class="modalDialog">
 ...
 <label for="first_name">First Name *</label><br>
  ...
  Address:<br>
  <textarea rows="4" cols="30" required></textarea><br><br>
...
<div id="signin" class="modalDialog">
  ...
  or <a href="Home Page.php">Return to Store</a>
</form>
    </div>
</div>
</div><br><hr>
